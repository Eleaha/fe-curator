...
export const ExhibitionCard = (singleExhibition: {
	exhibition: Exhibition;
}) => {
	// const userContext: UserContext | undefined = useContext(UserIdContext);
	// const userId = userContext!.userId;
	const { exhibition } = singleExhibition;
	return (
		<Link to={`/exhibitions?id=${exhibition.exhibition_id}`}>
			<div key={exhibition.exhibition_id} style={{backgroundColor: exhibition!.bg_colour}}>
